      ...
      <table id="filter-table">
            ...
            <tbody>
               ...
               <tr data-status="{{ $siswa['soft_deleted'] == 1 ? 'Active' : 'Inactive' }}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <td scope="row" class="flex items-center text-gray-900 whitespace-nowrap dark:text-white">
                     ...
                     alt="{{$siswa['siswa_nama']}}">
                        ...
                        <div class="ps-3">
                           ...
                           <div class="font-normal text-gray-500">{{$siswa['siswa_email']}}</div>
                           <div class="font-normal text-gray-500">{{$siswa['siswa_no_telp']}}</div>
                        </div>  
                  </td>
                  <td >
                     {{$siswa['siswa_nis']}}
                  ...
                  <td >
                     <x-button color="blue" url="admin/edit_pd/{{$siswa['siswa_nis']}}" text="Edit" />
                     <x-button color="red" url="#" text="Keluar" />
                  </td>
               </tr>
               @endforeach
